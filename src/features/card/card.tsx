...
import { Brawler } from "../../core/characters/model/brawler";
import { King } from "../../core/characters/model/king";
import { RightHand } from "../../core/characters/model/right-hand";
import { Squire } from "../../core/characters/model/squire";

export function Card(props: (Brawler | RightHand | Squire | King)[]) {
